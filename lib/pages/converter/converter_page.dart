    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text("Konverter Waktu Real-time", style: Theme.of(context).textTheme.titleLarge),
            ...
            Text("Konverter Mata Uang Dinamis", style: Theme.of(context).textTheme.titleLarge),
